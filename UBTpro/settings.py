"""
Django settings for UBTpro project.
...
SECRET_KEY = 'django-insecure-0v=d-a=w6^)z=(wmkn8(d#yg#mna&8l(%(rr)4*7!@7wpyc(jp'
...
WSGI_APPLICATION = 'UBTpro.wsgi.application'
